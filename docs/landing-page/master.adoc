...
.openliberty {
  background-image:url(/docs/images/project-select-icons/ol.svg);
  background-size:40%
}
...
<section id="runtimes">
  <div class="container">
    ...
    <div class="row">
      ...
      <div class="col-sm-3 runtime">
        <div class="fa icon openliberty"></div>
        <p >
          Learn how to use Open Liberty.
        </p>
        <a href="/docs/openliberty-runtime.html" class="btn btn-default" role="button">
          Learn more
        </a>
      </div>
    </div>
